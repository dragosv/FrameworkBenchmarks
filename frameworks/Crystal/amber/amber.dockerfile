...
ENV DATABASE_URL postgres://benchmarkdbuser:benchmarkdbpass@tfb-data base:5432/hello_world?initial_pool_size=10&max_idle_pool_size=10&retry_attempts=3&retry_delay=10&max_pool_size=10
